...
namespace Aula08Estoque
{
    public partial class Form1 : Form
    {
        ...
        void adicionarProdutos()
        {
            ...
            if(utilidades.txtBoxEstaVazio(txtNome) ==true || utilidades.txtBoxEstaVazio(txtQuantidade) == true)
            {
        ...
        {   
            ...
            //contabilizar todos os produtos
            int estoque = 0;
            for(int i = 0; i<produtosQuantidade.Count(); i++)
            {
